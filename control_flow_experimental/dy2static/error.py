...
class ErrorData:
    ...
    def numpy_api_check(self, format_exception, error_line):
        ...
        if is_numpy_api_err and func_str:
            return [
                "TypeError: Code '{}' called numpy API {}, please use Ivy API to replace it.".format(
                    error_line, func_str
                ),
    ...
    def create_message(self):
        ...
        # Add ivy traceback after user code traceback
        ivy_traceback_start_index = (
    ...
    def _simplify_error_value(self):
        ...
        # Add ivyaceback after user code traceback
        ivy_traceback_start_index = (
            user_code_traceback_index[-1] + 1
            if user_code_traceback_index
            else 0
