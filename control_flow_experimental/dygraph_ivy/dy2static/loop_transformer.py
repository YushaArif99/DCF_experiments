...
def create_while_nodes(
    ...
    [a, b, c] = control_flow_experimental.dygraph.dygraph_to_static.convert_while_loop(
    ...
    [a, b, __attribute_variable_1] = control_flow_experimental.dygraph.dygraph_to_static.convert_while_loop(
