...
from ._pytree import Context, _register_pytree_node

import ivy

__all__ = ["immutable_list", "immutable_dict", "Constant"]
...
class Constant:
    """
    Object representing a constant input to a function
    """

    def __init__(self, const: Union[ivy.Array, ivy.NativeArray, ivy.Container] = None):
        self.c = const

    def __repr__(self):
        return f"Constant_{self.c.__class__}"
